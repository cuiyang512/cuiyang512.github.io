...
\mytitle{Yang Cui}{yang.cui512@gmail.com}{https://github.com/cuiyang512}{Department of Earth Sciences, Uppsala University, Sweden} % Insert your custom title
...
\pdfbookmark[1]{Research Interests}{research_interests}
...
\pdfbookmark[1]{Field Experience}{field_exp}
...
\vspace{-.75em}
\small
\faGoogle~\href{https://scholar.google.com/citations?user=jCXHSzAAAAAJ&hl=en}{Google Scholar}\\
...
\newrefcontext[] % Will prefix bibliography numbers with this letter
...
\pdfbookmark[2]{First-Author Journal Articles}{journal-first}
...
\pdfbookmark[2]{Co-Author Journal Articles}{journal-co}
